...
export class ServerlessDataPipelineStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const pipelineLambda = new lambda.Function(this, 'PipelineFunction', {
      ...
      code: lambda.Code.fromAsset(path.join(__dirname, '../lambda')), // Correct path to your Lambda code
      environment: {
    ...
    const authorizerLambda = new lambda.Function(this, 'AuthorizerFunction', {
      ...
      code: lambda.Code.fromAsset(path.join(__dirname, '../lambda')), // Correct path to the authorizer Lambda code
    });
